...
mod tests {
    ...
    fn test_all_binary_operators() {
        ...
        for (op, expected_str) in test_cases {
            ...
            assert!(result.contains(expected_str), "Expected {} in {}", expected_str, result);
        }
    }
    ...
    fn test_print_statement_generation() {
        ...
        // String literal
        let result = compiler.generate_print_statement(&Expression::StringLiteral("hello".to_string()));
